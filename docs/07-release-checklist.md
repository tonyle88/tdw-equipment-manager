...
3. Khong commit `.env`, `GOOGLE_SCRIPT_URL`, `TDW_BOOTSTRAP_ADMIN_PASSWORD`, mat khau, token hay license key.
...
3. Xac nhan `GOOGLE_SCRIPT_URL` co o Production va Preview.
